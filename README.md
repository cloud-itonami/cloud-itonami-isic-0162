...
```bash
kbb -M:dev:run     # walk two clean sample+treatment lifecycles (no water source, near-water-source buffer-compliant), plus four HARD-hold cases, through the actor
